  ...
  return (
    <nav className="top-0 w-full bg-white flex items-center justify-between py-10 z-50">
      <div className="hidden md:flex absolute left-1/2 transform -translate-x-1/2 bg-white border border-gray-300 rounded-full px-4 py-2 shadow-md">
        ...
        <a href="/Cursos" className="px-6 py-1 !text-black font-semibold rounded-full transition-all duration-300 hover:bg-[#FD919C] hover:!text-white hover:scale-110 text-xs md:text-sm lg:text-base whitespace-nowrap">Para empresas</a>
      </div>
